...
import TestComp  from '../model/comptest'
...
const [inputvalue, setinputvalue] = useState({
  ...
  const handleUserInput = (toSearch) => {
      setFormState({...formState, filterText: toSearch.toLowerCase()
      ...
      >
        {(() => {
          ...
          if(itemCell.id === "Status")
          {
            ...
            if(dataArray[itemCell.id] === true)
            {
              
              return <li style={{color:"#006400"}}>Active</li>
            }

            else{
              return <li style={{color:"#8B0000"}}>In Active</li>
            }
          }

          else
          {
            return dataArray[itemCell.id]
          }
        })()}
  ...
  return (
    ...
    <div {...props}>
      ...
      <TestComp open={openModel} onClose={handleClose} inputValue={inputvalue} handleSubmit ={handleSubmit} onTextChange={onTextChange} />
    </div>
  )
}
